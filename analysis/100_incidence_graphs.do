...
*Unadjusted incidence moving average, by ethnicity (lines only)
	...
	twoway line ratio_white_ma mo_year_diagn, lcolor(ltblue) lstyle(solid) ytitle("Monthly incidence per 100,000 population", size(med)) || line ratio_mixed_ma mo_year_diagn, lcolor(eltblue) lstyle(solid) || line ratio_black_ma mo_year_diagn, lcolor(ebblue) lstyle(solid) || line ratio_asian_ma mo_year_diagn, lcolor(blue) lstyle(solid) || line ratio_other_ma mo_year_diagn, lcolor(navy) lstyle(solid) ylabel(, nogrid labsize(small)) xtitle("Date of diagnosis", size(medium) margin(medsmall)) xlabel(671 "2016" 683 "2017" 695 "2018" 707 "2019" 719 "2020" 731 "2021" 743 "2022" 755 "2023" 767 "2024" 779 "2025", nogrid labsize(small))  title("`disease_title'", size(medium)) xline(722) legend(region(fcolor(white%0)) order(1 "White" 2 "Mixed" 3 "Black" 4 "Asian" 5 "Other")) name(un_ma_ethn, replace) saving("$projectdir/output/figures/`disease_'_un_ma_ethn.gph", replace)
...
*Unadjusted incidence moving average, by IMD (lines only)
	...
	twoway line ratio_imd1_ma mo_year_diagn, lcolor(ltblue) lstyle(solid) ytitle("Monthly incidence per 100,000 population", size(med)) || line ratio_imd2_ma mo_year_diagn, lcolor(eltblue) lstyle(solid) || line ratio_imd3_ma mo_year_diagn, lcolor(ebblue) lstyle(solid) || line ratio_imd4_ma mo_year_diagn, lcolor(navy) lstyle(blue) || line ratio_imd5_ma mo_year_diagn, lcolor(navy) lstyle(solid) ylabel(, nogrid labsize(small)) xtitle("Date of diagnosis", size(medium) margin(medsmall)) xlabel(671 "2016" 683 "2017" 695 "2018" 707 "2019" 719 "2020" 731 "2021" 743 "2022" 755 "2023" 767 "2024" 779 "2025", nogrid labsize(small))  title("`disease_title'", size(medium)) xline(722) legend(region(fcolor(white%0)) order(1 "1 Most deprived" 2 "2" 3 "3" 4 "4" 5 "5 Least deprived")) name(un_ma_imd, replace) saving("$projectdir/output/figures/`disease_'_un_ma_imd.gph", replace)
